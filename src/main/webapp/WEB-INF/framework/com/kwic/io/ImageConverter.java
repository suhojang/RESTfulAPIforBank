...
public class ImageConverter {
	...
	public static BufferedImage read(File src) throws Exception{
		...
		try{
			...
			try{if(fis!=null)fis.close();}catch(Exception ex){fis=null;}
			try{if(jos!=null)jos.close();}catch(Exception ex){jos=null;}
		}
...
//			MediaTracker tracker	= new MediaTracker(new java.awt.Frame());
			MediaTracker tracker	= new MediaTracker(new Container());//리눅스나 유닉스에서 -Djava.awt.headless=true옵션을 주더라도 Frame을 쓸수는 없으므로 container로 변경
			...
			try{if(bas!=null)bas.close();}catch(Exception e){bas=null;}
...
//			MediaTracker tracker	= new MediaTracker(new java.awt.Frame());
	...
	public static void main(String[] args) throws Exception{
		...
		File src	= new File("E:/project/gswd/WebContent/upload_files/mbm/장정훈_750721-1^^D10001055EB16BF4EFA6BF34F2F76178^^1445906959880.JPG");
		File dest	= new File("E:/project/gswd/WebContent/upload_files/mbm/15080500030101.jpg");
